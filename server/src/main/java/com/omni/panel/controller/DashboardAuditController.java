...
import com.omni.panel.service.DashboardAuditService;

/**
 * 管理端仪表盘变更日志接口。
 */
@RestController
@RequestMapping("/api/admin/dashboard-audits")
@PreAuthorize("hasRole('ADMIN')")
public class DashboardAuditController {
    private final DashboardAuditService service;

    /**
     * @param service 仪表盘变更审计服务
     */
    public DashboardAuditController(DashboardAuditService service) {
     ...
     */
    @GetMapping
    public ApiResponse<PageResult<DashboardAuditMapper.AuditRow>> page(
