...
class QueryServicePermissionTest {
    ...
    private final SqlObjectAccessGuard sqlObjectAccessGuard = mock(SqlObjectAccessGuard.class);
    ...
    void 语义查询在数据集校验后再次校验底层数据源() {
        ...
        QueryRequest request = new QueryRequest(8L, List.of(), List.of(), null, null, List.of(), 10);
