...
import com.omni.panel.auth.AuthController;
...
import com.omni.panel.visualization.ChartController;
...
class ApiContractJsonTest {
    ...
    @Test
    void 查询提交字段匹配语义查询契约() {
        QueryRequest query = new QueryRequest(2L, List.of("region"), List.of("sales"),
